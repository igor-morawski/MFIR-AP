...
MODEL_CONFIG_KEYS = ['setup', 'dataset_intermediate_path', 'dataset_processed_parent_path', 'train_size', 'batch_size', 'loss_function', 'frames', 'frame_shift', 'view_IDs', 'epochs']
